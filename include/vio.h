...
{
public:
  void set_cam_model_string(std::string cam_model_string_param){
    cam_model_string = cam_model_string_param;
  }
  std::string cam_model_string;
  cv::Mat m_left_ud_map1, m_left_ud_map2;
  bool camera_fisheye_first = true;

  int grid_size;
  vk::AbstractCamera *cam;
  vk::PinholeCamera *pinhole_cam;
  vk::EquidistantCamera *fisheyeCamera;
  StatesGroup *state;
  ...
  // void computeJacobianAndUpdateEKFbyUco(cv::Mat img);
